...
public class MediaRouteControllerDialog extends AlertDialog {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (routeInfo != null) {
                ...
                if (isEnabled) {
                    ...
                    i3 = (int) (255.0f * this.mDisabledAlpha);
                }
    ...
    private void updatePlaybackControlLayout() {
        /*
        r8 = this;
        r0 = r8.canShowPlaybackControlLayout();
    ...
    L_0x00a0:
        r0 = r3;
    L_0x00a1:
        r1 = r8.mPlaybackControlButton;
        r1 = r1.getContext();
        if (r0 == 0) goto L_0x00b4;
    L_0x00a9:
        r2 = r8.isPauseActionSupported();
        if (r2 == 0) goto L_0x00b4;
    L_0x00af:
        r0 = android.support.v7.mediarouter.R.attr.mediaRoutePauseDrawable;
        r2 = android.support.v7.mediarouter.R.string.mr_controller_pause;
        goto L_0x00d1;
    L_0x00b4:
        if (r0 == 0) goto L_0x00c1;
    L_0x00b6:
        r2 = r8.isStopActionSupported();
        if (r2 == 0) goto L_0x00c1;
    L_0x00bc:
        r0 = android.support.v7.mediarouter.R.attr.mediaRouteStopDrawable;
        r2 = android.support.v7.mediarouter.R.string.mr_controller_stop;
        goto L_0x00d1;
    L_0x00c1:
        if (r0 != 0) goto L_0x00ce;
    L_0x00c3:
        r0 = r8.isPlayActionSupported();
        if (r0 == 0) goto L_0x00ce;
    L_0x00c9:
        r0 = android.support.v7.mediarouter.R.attr.mediaRoutePlayDrawable;
    ...
    L_0x00db:
        r3 = r8.mPlaybackControlButton;
        r0 = android.support.v7.app.MediaRouterThemeHelper.getThemeResource(r1, r0);
        r3.setImageResource(r0);
        r0 = r8.mPlaybackControlButton;
        r1 = r1.getResources();
        r1 = r1.getText(r2);
