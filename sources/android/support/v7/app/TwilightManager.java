...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - MeasurementDispatcher.MILLIS_PER_DAY, location.getLatitude(), location.getLongitude());
        ...
        long j5 = j3;
        boolean z3 = z2;
        instance.calculateTwilight(currentTimeMillis + MeasurementDispatcher.MILLIS_PER_DAY, location.getLatitude(), location.getLongitude());
