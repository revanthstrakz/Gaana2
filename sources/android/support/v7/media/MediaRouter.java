...
public final class MediaRouter {
    ...
    private static final class GlobalMediaRouter implements android.support.v7.media.RegisteredMediaRouteProviderWatcher.Callback, SyncCallback {
        ...
        public void updateDiscoveryRequest() {
            ...
            Object build = z ? builder.build() : MediaRouteSelector.EMPTY;
        ...
        /* JADX WARNING: Removed duplicated region for block: B:57:0x0161 A:{LOOP_END, LOOP:3: B:56:0x015f->B:57:0x0161} */
        ...
        private void updateSelectedRouteIfNeeded(boolean z) {
            ...
            if (this.mDefaultRoute == null && !this.mRoutes.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (isSystemDefaultRoute(routeInfo) && routeInfo.isSelectable()) {
            ...
            if (this.mBluetoothRoute == null && !this.mRoutes.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (isSystemLiveAudioOnlyRoute(routeInfo2) && routeInfo2.isSelectable()) {
                        this.mBluetoothRoute = routeInfo2;
                        str = MediaRouter.TAG;
                        StringBuilder stringBuilder2 = new StringBuilder();
                        stringBuilder2.append("Found bluetooth route: ");
                        stringBuilder2.append(this.mBluetoothRoute);
            ...
            if (this.mSelectedRoute == null || !this.mSelectedRoute.isSelectable()) {
                ...
                if (this.mSelectedRoute instanceof RouteGroup) {
                    ...
                    for (RouteInfo routeInfo3 : routes) {
                        hashSet.add(routeInfo3.mDescriptorId);
                    }
                    ...
                    for (RouteInfo routeInfo4 : routes) {
                        if (!this.mRouteControllerMap.containsKey(routeInfo4.mDescriptorId)) {
        ...
        private void setSelectedRouteInternal(@NonNull RouteInfo routeInfo, int i) {
            ...
            if (this.mSelectedRoute != routeInfo) {
                ...
                if (MediaRouter.DEBUG) {
                    String str2 = MediaRouter.TAG;
                    StringBuilder stringBuilder3 = new StringBuilder();
                    stringBuilder3.append("Route selected: ");
                    stringBuilder3.append(this.mSelectedRoute);
