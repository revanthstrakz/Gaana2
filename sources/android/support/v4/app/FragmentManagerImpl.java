            ...
            if (fragmentManagerState.mActive != null) {
                ...
                while (i4 < fragmentManagerState.mActive.length) {
                    ...
                    if (fragmentState2 != null) {
                        ...
                        r rVar = (viewModelStores == null || i4 >= viewModelStores.size()) ? null : (r) viewModelStores.get(i4);
                        Fragment instantiate = fragmentState2.instantiate(this.mHost, this.mContainer, this.mParent, fragmentManagerNonConfig2, rVar);
                        if (DEBUG) {
                            String str2 = TAG;
