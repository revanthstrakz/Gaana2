...
public final class MimeTypeFilter {
    ...
    private static boolean mimeTypeAgainstFilter(@NonNull String[] strArr, @NonNull String[] strArr2) {
        if (strArr2.length != 2) {
            ...
            if (!CBConstant.DEFAULT_PAYMENT_URLS.equals(strArr2[0]) && !strArr2[0].equals(strArr[0])) {
                return false;
            }
            if (CBConstant.DEFAULT_PAYMENT_URLS.equals(strArr2[1]) || strArr2[1].equals(strArr[1])) {
                return true;
            }
            return false;
        }
