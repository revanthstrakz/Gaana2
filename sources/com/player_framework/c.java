...
public class c implements a, Listener, f {
    ...
    public com.exoplayer2.a.a.a b() {
        return this.m != null ? this.m.l() : null;
    }
    ...
    public boolean d() {
        return this.m != null ? this.m.j() : false;
    }
    ...
    public int e() {
        return this.m != null ? (int) this.m.h() : 0;
    }
    ...
    public void a(Exception exception) {
        ...
        u.a().a("StreamingFailure", stringBuilder2, P);
        a(this, i2, i);
    }

    public void a(AdEvent adEvent) {
        if (adEvent.getAd() == null && adEvent.getType() == AdEventType.ALL_ADS_COMPLETED && f() > e() - 15000) {
            a(d(), 4);
        }
        ...
        c = o.c("LISTENER_KEY_PLAYER_ACTIVITY");
        if (c != null) {
            c.onAdEventUpdate(this, adEvent);
        }
    }
