...
public class at extends a implements b {
                ...
                if (!bdVar.l) {
                    ...
                    if (!((Boolean) beVar.v.get("didStartPlaying")).booleanValue()) {
                        ...
                        try {
                            ...
                            bdVar.a("VideoPlayed", (Map) hashMap);
                        } catch (Exception e) {
    ...
    public at(@NonNull Context context, @NonNull c cVar, @NonNull ah ahVar, @NonNull ao aoVar) {
        this.c = ahVar;
        this.a = new au(context, cVar, this.c, aoVar, this.d, this.e, this);
    ...
    public final View a(View view, ViewGroup viewGroup, boolean z, RenderView renderView) {
        aw awVar;
        if (view != null) {
            view = view.findViewWithTag("InMobiAdView");
            if (view != null) {
                awVar = (aw) view;
                if (z) {
                    awVar = this.a.b(awVar, viewGroup, renderView);
                } else {
                    awVar = this.a.a(awVar, viewGroup, renderView);
                }
            } else if (z) {
