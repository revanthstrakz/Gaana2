        ...
        try {
            ...
            if (this.h.c().k.i && activity != null && ((Boolean) this.g.get("enabled")).booleanValue()) {
                if (this.f == null) {
                    ...
                    HashMap a = c.a("moatClientLevel", "moatClientSlicer", (JSONArray) this.g.get("clientLevels"), (JSONArray) this.g.get("clientSlicers"), (JSONObject) this.g.get("zMoatExtras"));
                ...
                b.setOnTouchListener(new OnTouchListener() {
                    public final boolean onTouch(View view, MotionEvent motionEvent) {
                        ...
                        StringBuilder stringBuilder = new StringBuilder("Received touch event for DisplayTracker(");
                        stringBuilder.append(ae.this.f.hashCode());
    ...
    public final void a(int i) {
        if (4 == i) {
            try {
                ...
                StringBuilder stringBuilder = new StringBuilder("Received click event for DisplayTracker(");
