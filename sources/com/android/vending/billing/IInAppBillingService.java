...
public interface IInAppBillingService extends IInterface {
    ...
    public static abstract class a extends Binder implements IInAppBillingService {
        ...
        private static class a implements IInAppBillingService {
            private IBinder a;
            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 2:
                        ...
                        a = a(i, readString, readString5, bundle);
                        parcel2.writeNoException();
                        if (a != null) {
                            parcel2.writeInt(1);
                    ...
                    case 3:
                        parcel.enforceInterface("com.android.vending.billing.IInAppBillingService");
                        a = a(parcel.readInt(), parcel.readString(), parcel.readString(), parcel.readString(), parcel.readString());
                        parcel2.writeNoException();
                        if (a != null) {
                            parcel2.writeInt(1);
                            a.writeToParcel(parcel2, 1);
                    ...
                    case 6:
                        parcel.enforceInterface("com.android.vending.billing.IInAppBillingService");
                        i = c(parcel.readInt(), parcel.readString(), parcel.readString());
                        parcel2.writeNoException();
                        parcel2.writeInt(i);
                        return true;
                    case 7:
                        parcel.enforceInterface("com.android.vending.billing.IInAppBillingService");
                        a = a(parcel.readInt(), parcel.readString(), (List) parcel.createStringArrayList(), parcel.readString(), parcel.readString(), parcel.readString());
                        parcel2.writeNoException();
                        if (a != null) {
                            parcel2.writeInt(1);
                            a.writeToParcel(parcel2, 1);
                    ...
                    case 8:
                        ...
                        a = a(readInt, readString2, readString3, readString4, readString6, bundle);
                        parcel2.writeNoException();
                        if (a != null) {
                            parcel2.writeInt(1);
                            a.writeToParcel(parcel2, 1);
                    ...
                    case 9:
                        ...
                        a = a(readInt, readString2, readString3, readString4, bundle);
                        parcel2.writeNoException();
                        if (a != null) {
                            parcel2.writeInt(1);
                            a.writeToParcel(parcel2, 1);
                    ...
                    case 10:
                        ...
                        i = b(i, readString, readString7, bundle);
                        parcel2.writeNoException();
                        parcel2.writeInt(i);
                        return true;
                    default:
