...
public class MoreRadioActivityFragment extends BaseGaanaFragment implements OnRefreshListener, a, b<Object>, com.constants.a.a, IAddListItemView, ColombiaAdViewManager.b, c, l.a {
        ...
        if (this.f == null || this.loginStatus != this.mAppState.getCurrentUser().getLoginStatus()) {
            ...
            this.j.addOnScrollListener(new OnScrollListener() {
                public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                    ...
                    if (i == 0 && MoreRadioActivityFragment.this.q > MoreRadioActivityFragment.this.r) {
                        ...
                        MoreRadioActivityFragment.this.r = MoreRadioActivityFragment.this.q;
                    }
                }

                public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                    super.onScrolled(recyclerView, i, i2);
                    MoreRadioActivityFragment.this.q = MoreRadioActivityFragment.this.q + i2;
                }
            });
        ...
        if (this.v != null && !TextUtils.isEmpty(this.removeAdDeeplink)) {
            ...
            this.v.setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    ...
                    com.services.c.a(MoreRadioActivityFragment.this.mContext).a(MoreRadioActivityFragment.this.mContext, MoreRadioActivityFragment.this.removeAdDeeplink, MoreRadioActivityFragment.this.mAppState);
                }
            });
        }
    }
    ...
    private void e() {
        ...
        e.a();
        if (e.X == 0) {
            ColombiaAdViewManager.a().a(this.mContext, linearLayout, e.A, "RADIO_BOTTOM_BANNER", (l.a) this, new AdsUJData[0]);
        }
    }
    ...
    private int a(Context context, BaseGaanaFragment baseGaanaFragment) {
        if (this.e == null) {
            this.e = DynamicViewManager.a().b(this.t, context, baseGaanaFragment);
        }
        return this.e.size();
    }
        ...
        if (obj instanceof com.dynamicview.e) {
            ...
            if (eVar.c() != null && eVar.c().size() > 0) {
                ...
                for (int i = 0; i < eVar.c().size(); i++) {
                    if (!TextUtils.isEmpty(((com.dynamicview.e.a) eVar.c().get(i)).b())) {
                        this.t.add(new f.a(((com.dynamicview.e.a) eVar.c().get(i)).b(), "url", DynamicViewType.section_heading.name(), "url_seeall", "source_name", "ad_code", "0", "140"));
                    }
                    List a = ((com.dynamicview.e.a) eVar.c().get(i)).a();
                    if (a != null) {
                        this.t.addAll(a);
                    }
                }
                this.e = DynamicViewManager.a().b(this.t, this.mContext, this);
                d();
                a();
            }
        }
    ...
    public void onErrorResponse(VolleyError volleyError) {
        this.e = DynamicViewManager.a().b(com.dynamicview.a.c(), this.mContext, this);
        d();
    }
}
