...
final class n {
    ...
    static m a(ContentResolver contentResolver) {
        m mVar = null;
        if (contentResolver == null) {
            return null;
        }
        if (i.a().a("amazon_aid") == null && "Amazon".equals(Build.MANUFACTURER)) {
            int i = Secure.getInt(contentResolver, "limit_ad_tracking", 2);
            if (i == 0) {
                mVar = new m(e.AMAZON, Secure.getString(contentResolver, "advertising_id"), false);
            } else if (i != 2) {
                String string;
                String str = "";
                try {
                ...
                mVar = new m(e.AMAZON, string, true);
            }
        }
        return mVar;
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:43:0x00f9  */
    /* JADX WARNING: Removed duplicated region for block: B:46:0x0118  */
    /* JADX WARNING: Removed duplicated region for block: B:51:? A:{SYNTHETIC, RETURN, SKIP} */
    /* JADX WARNING: Removed duplicated region for block: B:48:0x0133 A:{SKIP} */
    ...
    L_0x0050:
        ...
        r5 = new com.appsflyer.n$a;	 Catch:{ Throwable -> 0x005d }
    ...
    L_0x005f:
        ...
        com.appsflyer.AFLogger.d(r5);
        r5 = com.appsflyer.i.a();
        r7 = "enableGpsFallback";
        r5 = r5.b(r7, r3);
        if (r5 == 0) goto L_0x00e8;
    L_0x0087:
        r2 = com.appsflyer.aa.a(r9);	 Catch:{ Throwable -> 0x00a6 }
        r6 = r2.a();	 Catch:{ Throwable -> 0x00a6 }
        r2 = r2.b();	 Catch:{ Throwable -> 0x00a6 }
        r2 = r2 ^ r3;
