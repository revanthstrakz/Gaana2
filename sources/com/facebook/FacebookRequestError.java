        ...
        try {
            if (jSONObject2.has("code")) {
                ...
                if (!HTTP_RANGE_SUCCESS.contains(i)) {
                    return new FacebookRequestError(i, -1, -1, null, null, null, null, false, jSONObject2.has("body") ? (JSONObject) Utility.getStringPropertyAsJSON(jSONObject2, "body", GraphResponse.NON_JSON_RESPONSE_PROPERTY) : null, jSONObject2, obj, httpURLConnection, null);
                }
            }
