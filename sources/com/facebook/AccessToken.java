...
public final class AccessToken implements Parcelable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(this.expires.equals(accessToken.expires) && this.permissions.equals(accessToken.permissions) && this.declinedPermissions.equals(accessToken.declinedPermissions) && this.token.equals(accessToken.token) && this.source == accessToken.source && this.lastRefresh.equals(accessToken.lastRefresh) && (!this.applicationId != null ? accessToken.applicationId != null : !this.applicationId.equals(accessToken.applicationId)) && this.userId.equals(accessToken.userId))) {
            z = false;
        }
        return z;
    }
