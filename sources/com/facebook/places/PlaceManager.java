...
public class PlaceManager {
    ...
    private static Bundle getCurrentPlaceParameters(CurrentPlaceRequestParams currentPlaceRequestParams, LocationPackage locationPackage) throws FacebookException {
        ...
        try {
            ...
            if (locationPackage != null) {
                ...
                jSONObject2.put(PARAM_ENABLED, locationPackage.isBluetoothScanningEnabled);
                ...
                if (list2 != null) {
                    ...
                    for (BluetoothScanResult bluetoothScanResult : list2) {
                        ...
                        jSONObject3.put(PARAM_PAYLOAD, bluetoothScanResult.payload);
                        jSONObject3.put(PARAM_RSSI, bluetoothScanResult.rssi);
                        jSONArray2.put(jSONObject3);
                    }
                    jSONObject2.put(PARAM_SCANS, jSONArray2);
                }
                bundle.putString(PARAM_BLUETOOTH, jSONObject2.toString());
            }
            return bundle;
