...
public final class ShareDialog extends FacebookDialogBase<ShareContent, Result> implements Sharer {
    ...
    private static DialogFeature getFeature(Class<? extends ShareContent> cls) {
        ...
        return ShareMediaContent.class.isAssignableFrom(cls) ? ShareDialogFeature.MULTIMEDIA : null;
    }
    ...
    private void logDialogShare(Context context, ShareContent shareContent, Mode mode) {
        ...
        String str2 = feature == ShareDialogFeature.SHARE_DIALOG ? "status" : feature == ShareDialogFeature.PHOTOS ? AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_PHOTO : feature == ShareDialogFeature.VIDEO ? "video" : feature == OpenGraphActionDialogFeature.OG_ACTION_DIALOG ? AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_OPENGRAPH : "unknown";
