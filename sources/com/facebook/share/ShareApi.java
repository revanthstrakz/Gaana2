...
public final class ShareApi {
    ...
    /* JADX WARNING: Missing block: B:15:?, code skipped:
            ...
            r9.remove(com.google.android.exoplayer2.text.ttml.TtmlNode.TAG_IMAGE);
     */
    ...
    private void sharePhotoContent(SharePhotoContent sharePhotoContent, FacebookCallback<Result> facebookCallback) {
        ...
        final FacebookCallback<Result> facebookCallback3 = facebookCallback2;
        AnonymousClass3 anonymousClass3 = new Callback() {
            public void onCompleted(GraphResponse graphResponse) {
                ...
                if (!arrayList3.isEmpty()) {
                    ...
                    ShareInternalUtility.invokeCallbackWithResults(facebookCallback3, ((JSONObject) arrayList2.get(0)).optString("id"), graphResponse);
                }
            }
        };
        try {
            ...
            for (SharePhoto sharePhoto : sharePhotoContent.getPhotos()) {
                try {
                    ...
                    if (bitmap != null) {
                        ...
                        arrayList4.add(GraphRequest.newUploadPhotoRequest(currentAccessToken, getGraphPath("photos"), bitmap, str, sharePhotoCommonParameters, (Callback) anonymousClass3));
                    } else {
                        arrayList4 = arrayList;
                        if (imageUrl != null) {
                            arrayList4.add(GraphRequest.newUploadPhotoRequest(currentAccessToken, getGraphPath("photos"), imageUrl, str, sharePhotoCommonParameters, (Callback) anonymousClass3));
                        }
                    }
                    arrayList = arrayList4;
    ...
    private void shareLinkContent(ShareLinkContent shareLinkContent, final FacebookCallback<Result> facebookCallback) {
        ...
        new GraphRequest(AccessToken.getCurrentAccessToken(), getGraphPath(d.c), bundle, HttpMethod.POST, anonymousClass4).executeAsync();
    }
