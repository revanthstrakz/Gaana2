        ...
        try {
            ...
            switch (a.valueOf(jSONObject.getString("type").toUpperCase())) {
                ...
                default:
                    ...
                    throw new b(adErrorType, stringBuilder.toString());
            }
            if (!jSONObject.getString("sdk_version").equals("5.0.0")) {
                throw new b(AdErrorType.BID_IMPRESSION_MISMATCH, String.format(Locale.US, "Bid %d for SDK version %s being used on SDK version %s", new Object[]{this.b, jSONObject.getString("sdk_version"), "5.0.0"}));
                ...
                if (jSONObject.getInt("template") != eVar.a() && (!hashSet.contains(Integer.valueOf(jSONObject.getInt("template"))) || !hashSet.contains(Integer.valueOf(eVar.a())))) {
                    throw new b(AdErrorType.BID_IMPRESSION_MISMATCH, String.format(Locale.US, "Bid %d for template %s being used on template %s", new Object[]{this.b, Integer.valueOf(jSONObject.getInt("template")), eVar}));
                }
            } else {
            ...
            com.facebook.ads.internal.s.d.a.a(context, "api", b.d, e);
