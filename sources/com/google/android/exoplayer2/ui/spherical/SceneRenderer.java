...
class SceneRenderer implements VideoFrameMetadataListener, CameraMotionListener {
    ...
    public final /* synthetic */ void lambda$init$0$SceneRenderer(SurfaceTexture surfaceTexture) {
    ...
    private void setProjection(@Nullable byte[] bArr, int i, long j) {
        ...
        if (i2 != this.lastStereoMode || !Arrays.equals(bArr2, this.lastProjectionData)) {
            ...
            if (this.lastProjectionData != null) {
                obj = ProjectionDecoder.decode(this.lastProjectionData, this.lastStereoMode);
            }
            if (obj == null || !ProjectionRenderer.isSupported(obj)) {
                obj = Projection.createEquirectangular(this.lastStereoMode);
            }
            this.projectionQueue.add(j, obj);
        }
    }
}
