...
public final class MlltFrame extends Id3Frame {
    ...
    public int hashCode() {
        return (31 * (((((((527 + this.mpegFramesBetweenReference) * 31) + this.bytesBetweenReference) * 31) + this.millisecondsBetweenReference) * 31) + Arrays.hashCode(this.bytesDeviations))) + Arrays.hashCode(this.millisecondsDeviations);
    }
