...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    static SpliceInsertCommand parseFromSection(ParsableByteArray parsableByteArray, long j, TimestampAdjuster timestampAdjuster) {
        ...
        if (z5) {
            ...
            j3 = (!z8 || z9) ? C.TIME_UNSET : TimeSignalCommand.parseSpliceTime(parsableByteArray, j);
            if (z8) {
                arrayList = emptyList;
            } else {
                ...
                while (i4 < readUnsignedByte2) {
                    ...
                    arrayList.add(new ComponentSplice(readUnsignedByte3, j4, timestampAdjuster2.adjustTsTimestamp(j4), null));
                    i4++;
