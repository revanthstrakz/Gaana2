...
public final class MpegAudioHeader {
    ...
    public static int getFrameSize(int i) {
        ...
        i = (i >>> 9) & 1;
        if (i3 == 3) {
            return (((12 * (i2 == 3 ? BITRATE_V1_L1[i4 - 1] : BITRATE_V2_L1[i4 - 1])) / i6) + i) * 4;
        }
    ...
    public static boolean populateHeader(int i, MpegAudioHeader mpegAudioHeader) {
        ...
        if (i3 == 3) {
            i6 = 384;
            i7 = (((12 * (i2 == 3 ? BITRATE_V1_L1[i4 - 1] : BITRATE_V2_L1[i4 - 1])) / i9) + i8) * 4;
        } else {
            i7 = 144;
            if (i2 == 3) {
                i7 = ((144 * (i3 == 2 ? BITRATE_V1_L2[i4 - 1] : BITRATE_V1_L3[i4 - 1])) / i9) + i8;
            } else {
                i4 = BITRATE_V2[i4 - 1];
                if (i3 == 1) {
                    i10 = 576;
        ...
        mpegAudioHeader.setValues(i2, MIME_TYPE_BY_LAYER[3 - i3], i7, i9, ((i >> 6) & 3) == 3 ? 1 : 2, ((8 * i7) * i9) / i6, i6);
        return true;
    }
