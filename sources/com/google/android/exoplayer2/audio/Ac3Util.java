...
public final class Ac3Util {
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = new int[]{32, 40, 48, 56, 64, 80, 96, 112, 128, MoEHelperUtils.BASELINE_SCREEN_DPI, PsExtractor.AUDIO_STREAM, 224, 256, ModuleDescriptor.MODULE_VERSION, 384, 448, 512, 576, 640};
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (i6 != 0) {
            ...
            if (position == 2 && (i8 == i9 || parsableBitArray.readBit())) {
                parsableBitArray2.skipBits(6);
            }
        ...
        return new SyncFrameInfo(str, i4, i3, i, i5, i2);
    }
