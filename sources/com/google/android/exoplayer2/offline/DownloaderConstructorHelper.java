...
public final class DownloaderConstructorHelper {
    ...
    public CacheDataSource buildCacheDataSource(boolean z) {
        ...
        return new CacheDataSource(this.cache, this.priorityTaskManager == null ? createDataSource2 : new PriorityDataSource(createDataSource2, this.priorityTaskManager, -1000), createDataSource, createDataSink, 1, null);
    }
}
