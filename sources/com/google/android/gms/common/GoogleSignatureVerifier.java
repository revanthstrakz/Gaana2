    ...
    private final zzm zzc(String str) {
        ...
        try {
            ...
            if (packageInfo == null) {
                ...
                zzb = (!zza.zzad || packageInfo.applicationInfo == null || (packageInfo.applicationInfo.flags & 2) == 0 || (honorsDebugCertificates && !zzc.zza(str2, zzf, false, false).zzad)) ? zza : zzm.zzb("debuggable release cert app rejected");
            }
            if (zzb.zzad) {
                this.zzan = str;
            }
