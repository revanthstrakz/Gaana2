    ...
    public static final class Builder {
        ...
        public final GoogleApiClient build() {
            ...
            while (it.hasNext()) {
                ...
                BaseClientBuilder baseClientBuilder = zai;
                zaq zaq2 = zaq;
                Map map = optionalApiSettings;
                Api api3 = api2;
                Iterator it2 = it;
                Client buildClient = zai.buildClient(this.mContext, this.zabj, buildClientSettings, obj, zaq2, zaq2);
            ...
            zaaw zaaw = new zaaw(this.mContext, new ReentrantLock(), this.zabj, clientSettings, this.zacc, this.zacd, arrayMap, this.zace, this.zacf, arrayMap2, this.zaca, zaaw.zaa(arrayMap2.values(), z), arrayList, false);
