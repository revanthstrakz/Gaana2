...
final class zztx implements zzxy {
    ...
    public final void zza(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzbe(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zzb(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzbh(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zzc(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzaw(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zzd(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzax(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zze(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzaz(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zzf(int i, List<Float> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzb(((Float) list.get(i)).floatValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zzg(int i, List<Double> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzc(((Double) list.get(i)).doubleValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zzh(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzbj(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zzi(int i, List<Boolean> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzt(((Boolean) list.get(i)).booleanValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zzj(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzbf(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zzk(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzbi(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zzl(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzba(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zzm(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzbg(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
    ...
    public final void zzn(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zztv.zzay(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzbtw.zzba(i3);
            while (i2 < list.size()) {
