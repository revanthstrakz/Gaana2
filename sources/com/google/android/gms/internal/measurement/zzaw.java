...
public class zzaw {
    ...
    private zzaw(zzay zzay) {
        ...
        StringBuilder stringBuilder = new StringBuilder(TsExtractor.TS_STREAM_TYPE_SPLICE_INFO + String.valueOf(str).length());
        ...
        zzcp.zzs(stringBuilder.toString());
    ...
    public final zzct zzcp() {
        return (this.zzwj == null || !this.zzwj.isInitialized()) ? null : this.zzwj;
    }
