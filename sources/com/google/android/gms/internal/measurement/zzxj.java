...
final class zzxj {
    ...
    private static int zzl(Class<?> cls) {
        return zzbum ? zzcco.zzcdf.arrayBaseOffset(cls) : -1;
    }

    private static int zzm(Class<?> cls) {
        return zzbum ? zzcco.zzcdf.arrayIndexScale(cls) : -1;
    }
    ...
    static {
        ...
        zzcco = zzd;
        Field zzyt = zzyt();
        long objectFieldOffset = (zzyt == null || zzcco == null) ? -1 : zzcco.zzcdf.objectFieldOffset(zzyt);
        zzcdd = objectFieldOffset;
    }
}
