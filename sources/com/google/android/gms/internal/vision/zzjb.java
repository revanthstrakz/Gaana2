...
final class zzjb extends zziy {
    ...
    L_0x003d:
        r9 = r7 + r5;
        r15 = com.google.android.gms.internal.vision.zziu.zza(r13, r7);
    ...
    L_0x0052:
        r14 = r7 + r5;
        r3 = com.google.android.gms.internal.vision.zziu.zza(r13, r7);
    ...
    L_0x0076:
        r14 = r7 + r5;
        r7 = com.google.android.gms.internal.vision.zziu.zza(r13, r7);
    ...
    L_0x00a3:
        r7 = r9 + r5;
        r14 = com.google.android.gms.internal.vision.zziu.zza(r13, r9);
    ...
    L_0x00c6:
        r14 = r9 + r5;
        r7 = com.google.android.gms.internal.vision.zziu.zza(r13, r9);
        if (r7 > r3) goto L_0x00d6;
    L_0x00ce:
        r7 = r14 + r5;
        r14 = com.google.android.gms.internal.vision.zziu.zza(r13, r14);
        if (r14 <= r3) goto L_0x004f;
    L_0x00d6:
        return r4;
        */
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i3 < length) {
            ...
            if (charAt2 < 128 && j < j2) {
                ...
                j4 = j + 1;
                zziu.zza(bArr2, j, (byte) (960 | (charAt2 >>> 6)));
                j = j4 + 1;
                zziu.zza(bArr2, j4, (byte) ((charAt2 & 63) | 128));
            } else if ((charAt2 < 55296 || 57343 < charAt2) && j <= j2 - 3) {
                j4 = j + 1;
                zziu.zza(bArr2, j, (byte) (480 | (charAt2 >>> 12)));
                j = j4 + 1;
                zziu.zza(bArr2, j4, (byte) (((charAt2 >>> 6) & 63) | 128));
                j4 = j + 1;
                zziu.zza(bArr2, j, (byte) ((charAt2 & 63) | 128));
                j = j4;
            } else if (j <= j2 - 4) {
                int i5 = i3 + 1;
                if (i5 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                        ...
                        j4 = j + 1;
                        zziu.zza(bArr2, j, (byte) (PsExtractor.VIDEO_STREAM_MASK | (i3 >>> 18)));
                        j = j4 + 1;
                        zziu.zza(bArr2, j4, (byte) (((i3 >>> 12) & 63) | 128));
                        j4 = j + 1;
                        zziu.zza(bArr2, j, (byte) (((i3 >>> 6) & 63) | 128));
                        j = j4 + 1;
                        zziu.zza(bArr2, j4, (byte) ((i3 & 63) | 128));
                        i3 = i5;
                    }
                } else {
                    i5 = i3;
    ...
    public final void zzb(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i < length) {
            ...
            j = position + 1;
            zziu.zza(position, (byte) charAt2);
            i++;
            position = j;
        }
        if (i == length) {
        ...
        while (i < length) {
            ...
            if (charAt2 < 128 && position < limit) {
                ...
                if ((charAt2 < 55296 || 57343 < charAt2) && position <= limit - 3) {
                    j3 = position + 1;
                    zziu.zza(position, (byte) (480 | (charAt2 >>> 12)));
                    position = j3 + 1;
                    zziu.zza(j3, (byte) (((charAt2 >>> 6) & 63) | 128));
                    j3 = position + 1;
                    zziu.zza(position, (byte) ((63 & charAt2) | 128));
                    position = j3;
                    ...
                    if (limit2 != length) {
                        ...
                        if (Character.isSurrogatePair(charAt2, charAt3)) {
                            ...
                            long j4 = position + 1;
                            zziu.zza(position, (byte) (PsExtractor.VIDEO_STREAM_MASK | (toCodePoint >>> 18)));
                            long j5 = j4 + 1;
                            zziu.zza(j4, (byte) (((toCodePoint >>> 12) & 63) | 128));
                            j4 = j5 + 1;
                            zziu.zza(j5, (byte) (((toCodePoint >>> 6) & 63) | 128));
                            j5 = j4 + 1;
                            zziu.zza(j4, (byte) ((toCodePoint & 63) | 128));
                            position = j5;
                            i = limit2;
                        }
                    } else {
                    ...
                    throw new zzja(limit2 - 1, length);
                } else {
                    if (55296 <= charAt2 && charAt2 <= 57343) {
                        limit2 = i + 1;
                ...
                j2 = zzb;
                j3 = position + 1;
                zziu.zza(position, (byte) (960 | (charAt2 >>> 6)));
                position = j3 + 1;
                zziu.zza(j3, (byte) ((63 & charAt2) | 128));
            }
            i++;
            zzb = j2;
