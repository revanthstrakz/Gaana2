    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i3 < length) {
            ...
            if (charAt2 < 128 && j < j2) {
                ...
                j = j4 + 1;
                zzfd.zza(bArr2, j4, (byte) ((charAt2 & 63) | 128));
            } else if ((charAt2 < 55296 || 57343 < charAt2) && j <= j2 - 3) {
                j4 = j + 1;
                zzfd.zza(bArr2, j, (byte) (480 | (charAt2 >>> 12)));
                j = j4 + 1;
                zzfd.zza(bArr2, j4, (byte) (((charAt2 >>> 6) & 63) | 128));
                j4 = j + 1;
                ...
                if (i5 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                        ...
                        j4 = j + 1;
                        zzfd.zza(bArr2, j, (byte) (PsExtractor.VIDEO_STREAM_MASK | (i3 >>> 18)));
                        j = j4 + 1;
                        zzfd.zza(bArr2, j4, (byte) (((i3 >>> 12) & 63) | 128));
                        j4 = j + 1;
                        zzfd.zza(bArr2, j, (byte) (((i3 >>> 6) & 63) | 128));
                        j = j4 + 1;
                        zzfd.zza(bArr2, j4, (byte) ((i3 & 63) | 128));
                        i3 = i5;
                    }
                } else {
                    i5 = i3;
            ...
            while (i2 < length) {
                ...
                if (charAt2 < 128 && position < limit) {
                    ...
                    if ((charAt2 < 55296 || 57343 < charAt2) && position <= limit - 3) {
                        j3 = position + 1;
                        zzfd.zza(position, (byte) (480 | (charAt2 >>> 12)));
                        position = j3 + 1;
                        zzfd.zza(j3, (byte) (((charAt2 >>> 6) & 63) | 128));
                        j3 = position + 1;
                        zzfd.zza(position, (byte) ((63 & charAt2) | 128));
                        position = j3;
                        ...
                        if (limit2 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                long j4 = position + 1;
                                zzfd.zza(position, (byte) (PsExtractor.VIDEO_STREAM_MASK | (toCodePoint >>> 18)));
                                long j5 = j4 + 1;
                                zzfd.zza(j4, (byte) (((toCodePoint >>> 12) & 63) | 128));
                                j4 = j5 + 1;
                                zzfd.zza(j5, (byte) (((toCodePoint >>> 6) & 63) | 128));
                                j5 = j4 + 1;
                                zzfd.zza(j4, (byte) ((toCodePoint & 63) | 128));
                                position = j5;
                                i2 = limit2;
                            }
                        } else {
                        ...
                        throw new zzfi(limit2 - 1, length);
                    } else {
                        if (55296 <= charAt2 && charAt2 <= 57343) {
                            limit2 = i2 + 1;
                    ...
                    j2 = zzb;
                    j3 = position + 1;
                    zzfd.zza(position, (byte) (960 | (charAt2 >>> 6)));
                    position = j3 + 1;
                    zzfd.zza(j3, (byte) ((63 & charAt2) | 128));
                }
                i2++;
                zzb = j2;
