...
public class zzcs extends zzcr {
        ...
        if (zzb.isInitialized()) {
            ...
            if (this.zzqw > 0 && zzds.zza(this.zzrm)) {
                ...
                if (this.zzrl && this.zzqu != null) {
                    ...
                    zza2 = zzds.zza((double) (((this.zzrh - this.zzrj) + this.zzqu.getRawY()) - this.zzqu.getY()), this.zzrm);
                    if (zza2 != 0) {
                        zzbm.zzgz = Long.valueOf(zza2);
                    }
                }
            }
            try {
            ...
            try {
                ...
                if (size > 0) {
                    ...
                    while (i < size) {
                        zzdr zza3 = zza(zzqo, (MotionEvent) this.zzqv.get(i), this.zzrm);
                        zzbm zzbm2 = new zzbm();
                        zzbm2.zzei = zza3.zztl;
                        zzbm2.zzej = zza3.zztm;
                        zzbl.zzfo[i] = zzbm2;
                        i++;
                    }
                }
            ...
            if (zzb.zzac() != null) {
                int zzy = zzb.zzy();
                arrayList.add(new zzef(zzb, zzbl));
                zzdl zzdl = zzb;
                zzbl zzbl2 = zzbl;
                arrayList.add(new zzei(zzdl, "OU2zTkMb3xVWxjElhSJNJtcyjBcBIax5KghmsB2DrHu3HRhgp4Bz1cQIIaak8Abf", "0aMkajKGfxJjxUakLLOcj8JypKv0GmCb3d+C/AP1yzc=", zzbl2, zzy, 1));
                arrayList.add(new zzed(zzdl, "teIp99oid1pENGWnU++9yOPCIwtIDIwejcakl+LfK5qHHKbt0MJt+8BqbhD17b1n", "NREPPB/9iy6pGr9Pw6YHALTcoiK6Qv0Fu8JVtmSXvzQ=", zzbl2, startTime, zzy, 25));
                int i2 = zzy;
                arrayList.add(new zzec(zzdl, "55W269KXvkwdzl5sfb0CcKPmBnPIftmJMRWEHFEIHMVBNbB9RYoQD/JeAhpTyftv", "xRFu2EA0XhZqR4z5v1+z5DRPRDh4cLaTVyZWq8w+32M=", zzbl2, i2, 44));
                arrayList.add(new zzeh(zzdl, "tSH6JN0/dsR0FAYjQVtAYWAamOw3jEQmk6Hr8jJN+yrtPJ4ZwRFL84dAlVlDBCND", "QIWClwyA1htDcymLB9H+9tV5qeIhlSOa2TsbKDGB4CU=", zzbl2, i2, 12));
                arrayList.add(new zzej(zzdl, "M1NS9rNHdzevdCO1BkBQDrEtWalzliBN1oXlHuD/PStxAuVrokFwJ8FTE8R3woq0", "4Nk49DU1yHD/oE1MfAOMbRwhDipAhidA7tdJouMJQrI=", zzbl2, i2, 3));
                arrayList.add(new zzeg(zzdl, "diFehzLUdSyhsDAHjo1jRWbuUSlDLM7ewQWDc6EGa5SkktywcOnUZVN2l852D8v/", "gccLIpNanlTav8umvHfA6CkZesdxV9Cr39ehhj7Z8L8=", zzbl2, i2, 22));
                arrayList.add(new zzeb(zzdl, "5Un4Bxdp8gVIANCZ39+qNPpJwSMKWP26YPuxiQ9CnPTd/FlU4AIzDaH9PI9I+CrN", "4Df+wFSysP9SafTWPUlnClwqa+KS42poxSq2xHfYKTY=", zzbl2, i2, 5));
                arrayList.add(new zzeq(zzdl, "ALF9qjihH/iYAQtvlhVRCPGKYo/wJshkjPnwFlKHSnSRd1pu6U+lD5JnTKlN/8Dh", "hp8obFMJgqHXmaR5pMrBIn7HvqDUI8ERyuIbnl0iT/M=", zzbl2, i2, 48));
                arrayList.add(new zzdy(zzdl, "DdZDLurYd8cqlTxFH9iUg4PWLqXdMHMkdrTyCVNVmPtO8AJJSQ+/YGXoMqGNOXWI", "c760NRjk4Ctk2HA0ROzb7VHBeyDIvOdXhTBmaaREC+Y=", zzbl2, i2, 49));
                arrayList.add(new zzen(zzdl, "HW6DUu9hdQUUJG4hyzA4/jDFe17EFpXdJQ2aqCpScU07e6PXExB1P1rW0uW0StIw", "XCJaUXNSa18os9LIeCcjZdYTv1kZvdxKgQEEsV6JTUc=", zzbl2, i2, 51));
                arrayList.add(new zzem(zzdl, "dUZXsTQGXogdq7xqgYL8i0iimZLTpa9AoXZpRO79MP7o6nVl+DoNjuCg63H0zXDK", "Vz6KZKN/XNSe7DawDVk5XNlgz1HLOOLd+9M1b4lusVA=", zzbl2, i2, 45, new Throwable().getStackTrace()));
                arrayList.add(new zzer(zzdl, "JpT53kCFZ5UGhS3QgNfIxU7Zo+2b3P+3vnYveTkMBHt4zfnotqnDwQTaAD1ryBW9", "SQmHWbTAzPlYuz5I3xZRZNLM/2+IGX009ow9MnjYfrI=", zzbl2, i2, 57, view));
                arrayList.add(new zzel(zzdl, "9KTvYPBd7MH2ciAlBu9OHvde4n0Fwv5nDeizahStujRhSUn5FAOJjVUu69hMaCIH", "kiOoUcTqb+PvEdOeeDwNvvUZgbOHeCWSZHc9NNTPPv4=", zzbl2, i2, 61));
                if (((Boolean) zzwu.zzpz().zzd(zzaan.zzcti)).booleanValue()) {
                    arrayList.add(new zzdx(zzb, "TxRdKOZ0pZeBXpIwiLITX81ZqIx50eBVN3DINE4ZBUPdk4novnMzQn3dOLT7/176", "m2+gcfdQWoY+6hOETk2mr0SsbjGMFJBzTmSItOYkEfM=", zzbl, zzy, 62, view, activity));
                }
                if (((Boolean) zzwu.zzpz().zzd(zzaan.zzctk)).booleanValue()) {
                    arrayList.add(new zzeo(zzb, "9MXEPmGC/7986z/wLWv2b+1iRSmCMoPNrO7Sy/hYl1riiNMJKXOd189OeOHpltpa", "DjhY2o1Svq1HpINv7cU+bAqV+OA81bMZ6vkVBk0u3II=", zzbl, zzy, 53, this.zzrt));
                }
            }
        } else {
            zzbl.zzeo = Long.valueOf(PlaybackStateCompat.ACTION_PREPARE);
            arrayList = Arrays.asList(new Callable[]{new zzef(zzb, zzbl)});
        }
        zza(arrayList);
        return zzbl;
    }
    ...
    public List<Callable<Void>> zza(zzdl zzdl, Context context, zzbl zzbl, zzbi zzbi) {
        ...
        if (zzdl.isInitialized()) {
            zzdl zzdl2 = zzdl;
            zzbl zzbl2 = zzbl;
            arrayList.add(new zzea(zzdl2, "qsalJ2RwJdF4/xIua4a94Fnnrn+PF/pR/qVYX8QPAaTQDa6NRA9etEnbnhQWblFD", "G68A6YJ+VRJhgHK56Kx1RoGHOyqehPG7tlyyPwtcr7Q=", zzbl2, zzy, 27, context, zzbi));
            arrayList.add(new zzed(zzdl2, "teIp99oid1pENGWnU++9yOPCIwtIDIwejcakl+LfK5qHHKbt0MJt+8BqbhD17b1n", "NREPPB/9iy6pGr9Pw6YHALTcoiK6Qv0Fu8JVtmSXvzQ=", zzbl2, startTime, zzy, 25));
            int i = zzy;
            arrayList.add(new zzei(zzdl2, "OU2zTkMb3xVWxjElhSJNJtcyjBcBIax5KghmsB2DrHu3HRhgp4Bz1cQIIaak8Abf", "0aMkajKGfxJjxUakLLOcj8JypKv0GmCb3d+C/AP1yzc=", zzbl2, i, 1));
            arrayList.add(new zzek(zzdl2, "2a/4JIVPkDFYMOVDvRgiPhzuBvaMjATDrq7QEolObsd/NV02/K8EoZgGgGExyTEN", "zAquriPjpzqGJfvs/9ulqqLxOML+UEqSlyjOz6Tu5VU=", zzbl2, i, 31));
            arrayList.add(new zzep(zzdl2, "nm3YsDf+7WO+MEOswfwP/mr6SZsOgwQFOzWfB0E01vRE8SnBNpESCxeGx/E3obzH", "ntbFRCAexgxz9p8O68TxIQjW9W7nZKRNbG91vq8F9ro=", zzbl2, i, 33));
            arrayList.add(new zzdz(zzdl2, "1IkHdmwdwv9wD8tmJQC+h66q1PQxvS+V9UrDno8I9cxHFnF0E43buTrJO+G+/gQl", "A9jthiAQc+izVBr4mJNKEZTv7NXyHy0tI8Qg667eCzo=", zzbl2, i, 29, context));
            arrayList.add(new zzeb(zzdl2, "5Un4Bxdp8gVIANCZ39+qNPpJwSMKWP26YPuxiQ9CnPTd/FlU4AIzDaH9PI9I+CrN", "4Df+wFSysP9SafTWPUlnClwqa+KS42poxSq2xHfYKTY=", zzbl2, i, 5));
            arrayList.add(new zzeh(zzdl2, "tSH6JN0/dsR0FAYjQVtAYWAamOw3jEQmk6Hr8jJN+yrtPJ4ZwRFL84dAlVlDBCND", "QIWClwyA1htDcymLB9H+9tV5qeIhlSOa2TsbKDGB4CU=", zzbl2, i, 12));
            arrayList.add(new zzej(zzdl2, "M1NS9rNHdzevdCO1BkBQDrEtWalzliBN1oXlHuD/PStxAuVrokFwJ8FTE8R3woq0", "4Nk49DU1yHD/oE1MfAOMbRwhDipAhidA7tdJouMJQrI=", zzbl2, i, 3));
            arrayList.add(new zzec(zzdl2, "55W269KXvkwdzl5sfb0CcKPmBnPIftmJMRWEHFEIHMVBNbB9RYoQD/JeAhpTyftv", "xRFu2EA0XhZqR4z5v1+z5DRPRDh4cLaTVyZWq8w+32M=", zzbl2, i, 44));
            arrayList.add(new zzeg(zzdl2, "diFehzLUdSyhsDAHjo1jRWbuUSlDLM7ewQWDc6EGa5SkktywcOnUZVN2l852D8v/", "gccLIpNanlTav8umvHfA6CkZesdxV9Cr39ehhj7Z8L8=", zzbl2, i, 22));
            arrayList.add(new zzeq(zzdl2, "ALF9qjihH/iYAQtvlhVRCPGKYo/wJshkjPnwFlKHSnSRd1pu6U+lD5JnTKlN/8Dh", "hp8obFMJgqHXmaR5pMrBIn7HvqDUI8ERyuIbnl0iT/M=", zzbl2, i, 48));
            arrayList.add(new zzdy(zzdl2, "DdZDLurYd8cqlTxFH9iUg4PWLqXdMHMkdrTyCVNVmPtO8AJJSQ+/YGXoMqGNOXWI", "c760NRjk4Ctk2HA0ROzb7VHBeyDIvOdXhTBmaaREC+Y=", zzbl2, i, 49));
            arrayList.add(new zzen(zzdl2, "HW6DUu9hdQUUJG4hyzA4/jDFe17EFpXdJQ2aqCpScU07e6PXExB1P1rW0uW0StIw", "XCJaUXNSa18os9LIeCcjZdYTv1kZvdxKgQEEsV6JTUc=", zzbl2, i, 51));
            arrayList.add(new zzel(zzdl2, "9KTvYPBd7MH2ciAlBu9OHvde4n0Fwv5nDeizahStujRhSUn5FAOJjVUu69hMaCIH", "kiOoUcTqb+PvEdOeeDwNvvUZgbOHeCWSZHc9NNTPPv4=", zzbl2, i, 61));
            return arrayList;
        }
        zzbl.zzeo = Long.valueOf(PlaybackStateCompat.ACTION_PREPARE);
        return arrayList;
