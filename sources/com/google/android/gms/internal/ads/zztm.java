...
public final class zztm extends zztd {
    ...
    /* JADX WARNING: Missing block: B:24:0x006e, code skipped:
            return r1;
     */
    public final byte[] zzay(java.lang.String r11) {
        /*
        r10 = this;
        r0 = r10.mLock;
        monitor-enter(r0);
        r1 = r10.zzoc();	 Catch:{ all -> 0x006f }
        r10.zzbze = r1;	 Catch:{ all -> 0x006f }
        r1 = r10.zzbze;	 Catch:{ all -> 0x006f }
        r2 = 0;
    ...
    L_0x0012:
        ...
        r11 = r10.zzbze;	 Catch:{ all -> 0x006f }
        r11 = r11.digest();	 Catch:{ all -> 0x006f }
        r1 = r11.length;	 Catch:{ all -> 0x006f }
        r3 = r10.zzbzh;	 Catch:{ all -> 0x006f }
        if (r1 <= r3) goto L_0x0034;
    L_0x0031:
        r1 = r10.zzbzh;	 Catch:{ all -> 0x006f }
        goto L_0x0035;
    L_0x0034:
        r1 = r11.length;	 Catch:{ all -> 0x006f }
    L_0x0035:
        ...
        r11 = r10.zzbzi;	 Catch:{ all -> 0x006f }
        r3 = 8;
        r11 = r11 % r3;
    ...
    L_0x0055:
        ...
        r11 = 8 - r11;
        r4 = r4 >>> r11;
        r11 = r10.zzbzh;	 Catch:{ all -> 0x006f }
        r11 = r11 + -1;
    L_0x005f:
        if (r11 < 0) goto L_0x006d;
    L_0x0061:
