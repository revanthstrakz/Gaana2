...
final class zzbsa implements zzbtd {
    ...
    public final <T> zzbtc<T> zze(Class<T> cls) {
        ...
        if (zzc.zzaoa()) {
            ...
            if (zza(zzc)) {
                return zzbsp.zza((Class) cls, zzc, zzbsv.zzaoe(), zzbrv.zzanr(), zzbte.zzaom(), zzbqt.zzamg(), zzbsi.zzanx());
            }
            return zzbsp.zza((Class) cls, zzc, zzbsv.zzaoe(), zzbrv.zzanr(), zzbte.zzaom(), null, zzbsi.zzanx());
        } else if (zza(zzc)) {
            return zzbsp.zza((Class) cls, zzc, zzbsv.zzaod(), zzbrv.zzanq(), zzbte.zzaok(), zzbqt.zzamh(), zzbsi.zzanw());
        } else {
            return zzbsp.zza((Class) cls, zzc, zzbsv.zzaod(), zzbrv.zzanq(), zzbte.zzaol(), null, zzbsi.zzanw());
        }
    }
