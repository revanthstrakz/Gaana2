...
public final class zzakr {
    ...
    public zzakr(JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject != null) {
            ...
            zzbv.zzlz();
            this.zzdlq = zzakz.zza(jSONObject, "click_urls");
            zzbv.zzlz();
            this.zzdlr = zzakz.zza(jSONObject, "imp_urls");
            zzbv.zzlz();
            this.zzdls = zzakz.zza(jSONObject, "downloaded_imp_urls");
            zzbv.zzlz();
            this.zzdlt = zzakz.zza(jSONObject, "nofill_urls");
            zzbv.zzlz();
            this.zzdlu = zzakz.zza(jSONObject, "remote_ping_urls");
            this.zzdlv = jSONObject.optBoolean("render_in_browser", false);
            long optLong = jSONObject.optLong("refresh", -1);
            if (optLong > 0) {
                j = 1000 * optLong;
            }
            this.zzdlx = j;
            zzawd zza = zzawd.zza(jSONObject.optJSONArray("rewards"));
            if (zza == null) {
                this.zzdly = null;
                this.zzdlz = 0;
            } else {
            ...
            this.zzdmc = jSONObject.optBoolean("use_displayed_impression", false);
            this.zzdmd = jSONObject.optBoolean("allow_pub_rendered_attribution", false);
            this.zzdme = jSONObject.optBoolean("allow_pub_owned_ad_view", false);
            this.zzdmf = jSONObject.optBoolean("allow_custom_click_gesture", false);
            return;
        }
        this.zzdlo = -1;
        this.zzdlq = null;
