...
public final class zzatb extends AbstractSafeParcelable {
    ...
    @Constructor
    public zzatb(@Param(id = 1) Bundle bundle, @Param(id = 2) zzbbi zzbbi, @Param(id = 3) ApplicationInfo applicationInfo, @Param(id = 4) String str, @Param(id = 5) List<String> list, @Param(id = 6) PackageInfo packageInfo, @Param(id = 7) String str2, @Param(id = 8) boolean z, @Param(id = 9) String str3) {
        this.zzdzn = bundle;
        this.zzdzo = zzbbi;
