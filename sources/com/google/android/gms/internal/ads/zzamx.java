...
public final class zzamx extends zzalz {
    ...
    public final zzadb zzsb() {
        ...
        return icon != null ? new zzabr(icon.getDrawable(), icon.getUri(), icon.getScale()) : null;
    }
    ...
    public final double getStarRating() {
        return this.zzdom.getStarRating() != null ? this.zzdom.getStarRating().doubleValue() : -1.0d;
    }
    ...
    public final zzyp getVideoController() {
        return this.zzdom.getVideoController() != null ? this.zzdom.getVideoController().zzbc() : null;
    }
