...
final class zzbuc {
    ...
    private static int zzak(int i, int i2) {
    ...
    private static int zzn(byte[] bArr, int i, int i2) {
        byte b = bArr[i - 1];
        switch (i2 - i) {
            case 0:
                return zzga(b);
    ...
    L_0x004c:
        r8 = new com.google.android.gms.internal.ads.zzbug;
        r8.<init>(r2, r4);
        throw r8;
    L_0x0052:
        r2 = r2 + 1;
    ...
    L_0x007b:
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbuc.zza(java.lang.CharSequence):int");
    }
    ...
    static {
        zzbue zzbuf;
        Object obj = (zzbua.zzapc() && zzbua.zzapd()) ? 1 : null;
        if (obj == null || zzbpp.zzakl()) {
            zzbuf = new zzbuf();
        } else {
            zzbuf = new zzbuh();
        }
