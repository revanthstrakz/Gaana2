...
public final class zzqk extends Surface {
            ...
            if (!zzbik) {
                if (zzqe.SDK_INT >= 17) {
                    ...
                    if (eglQueryString != null && eglQueryString.contains("EGL_EXT_protected_content")) {
                        z = zzqe.SDK_INT == 24 && ((zzqe.MODEL.startsWith("SM-G950") || zzqe.MODEL.startsWith("SM-G955")) && !context.getPackageManager().hasSystemFeature("android.hardware.vr.high_performance"));
                        if (!z) {
                            z2 = true;
                        }
                    }
    ...
    /* synthetic */ zzqk(zzqm zzqm, SurfaceTexture surfaceTexture, boolean z, zzql zzql) {
        this(zzqm, surfaceTexture, z);
    }
}
