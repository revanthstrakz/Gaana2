...
public final class zzakq {
    ...
    public zzakq(JSONObject jSONObject) throws JSONException {
        ...
        if (optJSONObject != null) {
            zzbv.zzlz();
            zza = zzakz.zza(optJSONObject, "manual_impression_urls");
        } else {
            zza = null;
        }
        this.zzdlc = zza;
        ...
        this.zzdle = optJSONObject != null ? optJSONObject.toString() : null;
        this.zzdky = optJSONObject != null ? optJSONObject.optString("class_name") : null;
        ...
        this.zzdlk = optJSONObject != null ? optJSONObject.toString() : null;
        zzbv.zzlz();
        this.zzdll = zzakz.zza(jSONObject, "template_ids");
        optJSONObject = jSONObject.optJSONObject("ad_loader_options");
        this.zzdlm = optJSONObject != null ? optJSONObject.toString() : null;
