...
public final class zzakz {
    ...
    public static void zza(Context context, String str, zzaxf zzaxf, String str2, boolean z, List<String> list) {
        if (list != null && !list.isEmpty()) {
            String str3 = z ? "1" : "0";
            for (String zza : list) {
                String zza2 = zza(zza(zza(zza(zza(zza(zza(zza2, "@gw_adlocid@", str2), "@gw_adnetrefresh@", str3), "@gw_qdata@", zzaxf.zzehj.zzdlw), "@gw_sdkver@", str), "@gw_sessid@", zzwu.zzqa()), "@gw_seqnum@", zzaxf.zzdwj), "@gw_adnetstatus@", zzaxf.zzehk);
                if (zzaxf.zzdnb != null) {
                    zza2 = zza(zza(zza2, "@gw_adnetid@", zzaxf.zzdnb.zzdkv), "@gw_allocid@", zzaxf.zzdnb.zzdkx);
                }
                zza2 = zzawz.zzb(zza2, context, zzaxf.zzdzf);
                zzbv.zzlf();
    ...
    public static void zza(Context context, String str, List<String> list, @Nullable String str2, @Nullable String str3, @Nullable zzawd zzawd) {
        if (list != null && !list.isEmpty()) {
            ...
            for (String zza : list) {
                String zza2 = zza(zza(zza(zza2, "@gw_rwd_userid@", Uri.encode(str2)), "@gw_rwd_custom_data@", Uri.encode(str3)), "@gw_tmstmp@", Long.toString(currentTimeMillis));
                if (zzawd != null) {
