...
public final class zzoh {
    ...
    public final int hashCode() {
        String str = null;
        return ((((((((((((((((((((str.hashCode() * 31) + str.hashCode()) * 31) * 31) + this.zzbes) * 31) + this.zzbet) * 31) + this.zzbeu) * 31) + this.zzbev) * 31) + this.zzbew) * 31) + this.zzbex) * 31) + this.zzbey) * 31) + this.viewportWidth) * 31) + this.viewportHeight;
    }
}
