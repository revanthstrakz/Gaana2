...
final class zzbqm implements zzbup {
    ...
    public final void zza(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzfe(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zzb(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzfh(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zzc(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzbb(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zzd(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzbc(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zze(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzbe(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zzf(int i, List<Float> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzg(((Float) list.get(i)).floatValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zzg(int i, List<Double> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzc(((Double) list.get(i)).doubleValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zzh(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzfj(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zzi(int i, List<Boolean> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzbe(((Boolean) list.get(i)).booleanValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zzj(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzff(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zzk(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzfi(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zzl(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzbf(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zzm(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzfg(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
    ...
    public final void zzn(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzbqk.zzbd(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzflo.zzfa(i3);
            while (i2 < list.size()) {
