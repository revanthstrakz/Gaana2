...
public final class zzaoj extends zzaok implements zzu<zzbgg> {
    ...
    public final /* synthetic */ void zza(Object obj, Map map) {
        ...
        this.zzdin.zza("onDeviceFeaturesReceived", new zzaog(new zzaoi().zzz(this.zzdqd.zzqr()).zzy(this.zzdqd.zzqs()).zzaa(this.zzdqd.zzqu()).zzab(this.zzdqd.zzqt()).zzac(true), null).zzvn());
        int[] iArr = new int[2];
