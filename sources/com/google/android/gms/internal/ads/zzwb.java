...
public final class zzwb extends AbstractSafeParcelable {
    ...
    public final zzwb zzpm() {
        ...
        long j = this.zzcjb;
        int i2 = this.zzcjc;
        List list = this.zzcjd;
        boolean z = this.zzcje;
        int i3 = this.zzcjf;
        boolean z2 = this.zzcjg;
        String str = this.zzcjh;
        zzzs zzzs = this.zzcji;
        Location location = this.zzcjj;
        String str2 = this.zzcjk;
        String str3 = str2;
        return new zzwb(i, j, bundle2, i2, list, z, i3, z2, str, zzzs, location, str3, this.zzcjl, this.zzcjm, this.zzcjn, this.zzcjo, this.zzcjp, this.zzcjq, this.zzcjr, this.zzcjs, this.zzcjt);
    }
}
