...
final class zzbuh extends zzbue {
    ...
    L_0x003d:
        r9 = r7 + r5;
        r15 = com.google.android.gms.internal.ads.zzbua.zza(r13, r7);
    ...
    L_0x0052:
        r14 = r7 + r5;
        r3 = com.google.android.gms.internal.ads.zzbua.zza(r13, r7);
    ...
    L_0x0076:
        r14 = r7 + r5;
        r7 = com.google.android.gms.internal.ads.zzbua.zza(r13, r7);
    ...
    L_0x00a3:
        r7 = r9 + r5;
        r14 = com.google.android.gms.internal.ads.zzbua.zza(r13, r9);
    ...
    L_0x00c6:
        r14 = r9 + r5;
        r7 = com.google.android.gms.internal.ads.zzbua.zza(r13, r9);
        if (r7 > r3) goto L_0x00d6;
    L_0x00ce:
        r7 = r14 + r5;
        r14 = com.google.android.gms.internal.ads.zzbua.zza(r13, r14);
        if (r14 <= r3) goto L_0x004f;
    L_0x00d6:
        return r4;
        */
    ...
    public final String zzo(byte[] bArr, int i, int i2) throws zzbrl {
        ...
        while (i < i4) {
            ...
            if (zzbud.zze(zza2)) {
                ...
                while (i5 < i4) {
                    zza2 = zzbua.zza(bArr, (long) i5);
                    if (!zzbud.zze(zza2)) {
                        break;
                    }
                    i5++;
                    i3 = i7 + 1;
                    zzbud.zza(zza2, cArr, i7);
                    i7 = i3;
                }
                i = i5;
                i6 = i7;
                ...
                i7 = i5 + 1;
                i3 = i6 + 1;
                zzbud.zza(zza2, zzbua.zza(bArr, (long) i5), cArr, i6);
                i = i7;
                i6 = i3;
                ...
                i3 = i7 + 1;
                int i8 = i6 + 1;
                zzbud.zza(zza2, zzbua.zza(bArr, (long) i5), zzbua.zza(bArr, (long) i7), cArr, i6);
                i = i3;
                i6 = i8;
            } else if (i5 >= i4 - 2) {
                throw zzbrl.zzank();
                ...
                i7 = i5 + 1;
                byte zza3 = zzbua.zza(bArr, (long) i5);
                i5 = i7 + 1;
                int i9 = i5 + 1;
                int i10 = i6 + 1;
                zzbud.zza(zza2, zza3, zzbua.zza(bArr, (long) i7), zzbua.zza(bArr, (long) i5), cArr, i6);
                i = i9;
                i6 = i10 + 1;
            }
        }
    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i3 < length) {
            ...
            if (charAt2 < 128 && j < j2) {
                ...
                j4 = j + 1;
                zzbua.zza(bArr2, j, (byte) (960 | (charAt2 >>> 6)));
                j = j4 + 1;
                zzbua.zza(bArr2, j4, (byte) ((charAt2 & 63) | 128));
            } else if ((charAt2 < 55296 || 57343 < charAt2) && j <= j2 - 3) {
                j4 = j + 1;
                zzbua.zza(bArr2, j, (byte) (480 | (charAt2 >>> 12)));
                j = j4 + 1;
                zzbua.zza(bArr2, j4, (byte) (((charAt2 >>> 6) & 63) | 128));
                j4 = j + 1;
                zzbua.zza(bArr2, j, (byte) ((charAt2 & 63) | 128));
                j = j4;
            } else if (j <= j2 - 4) {
                int i5 = i3 + 1;
                if (i5 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                        ...
                        j4 = j + 1;
                        zzbua.zza(bArr2, j, (byte) (PsExtractor.VIDEO_STREAM_MASK | (i3 >>> 18)));
                        j = j4 + 1;
                        zzbua.zza(bArr2, j4, (byte) (((i3 >>> 12) & 63) | 128));
                        j4 = j + 1;
                        zzbua.zza(bArr2, j, (byte) (((i3 >>> 6) & 63) | 128));
                        j = j4 + 1;
                        zzbua.zza(bArr2, j4, (byte) ((i3 & 63) | 128));
                        i3 = i5;
                    }
                } else {
                    i5 = i3;
    ...
    public final void zzb(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        long position = zzo + ((long) byteBuffer.position());
        long limit = zzo + ((long) byteBuffer.limit());
        int length = charSequence.length();
        int limit2;
        ...
        while (i < length) {
            ...
            if (charAt2 < 128 && position < limit) {
                ...
                if ((charAt2 < 55296 || 57343 < charAt2) && position <= limit - 3) {
                    j3 = position + 1;
                    zzbua.zza(position, (byte) (480 | (charAt2 >>> 12)));
                    position = j3 + 1;
                    zzbua.zza(j3, (byte) (((charAt2 >>> 6) & 63) | 128));
                    j3 = position + 1;
                    zzbua.zza(position, (byte) ((63 & charAt2) | 128));
                    position = j3;
                    ...
                    if (limit2 != length) {
                        ...
                        if (Character.isSurrogatePair(charAt2, charAt3)) {
                            ...
                            long j4 = position + 1;
                            zzbua.zza(position, (byte) (PsExtractor.VIDEO_STREAM_MASK | (toCodePoint >>> 18)));
                            long j5 = j4 + 1;
                            zzbua.zza(j4, (byte) (((toCodePoint >>> 12) & 63) | 128));
                            j4 = j5 + 1;
                            zzbua.zza(j5, (byte) (((toCodePoint >>> 6) & 63) | 128));
                            j5 = j4 + 1;
                            zzbua.zza(j4, (byte) ((toCodePoint & 63) | 128));
                            position = j5;
                            i = limit2;
                        }
                    } else {
                    ...
                    throw new zzbug(limit2 - 1, length);
                } else {
                    if (55296 <= charAt2 && charAt2 <= 57343) {
                        limit2 = i + 1;
                ...
                j2 = zzo;
                j3 = position + 1;
                zzbua.zza(position, (byte) (960 | (charAt2 >>> 6)));
                position = j3 + 1;
                zzbua.zza(j3, (byte) ((63 & charAt2) | 128));
            }
            i++;
            zzo = j2;
            byteBuffer2 = byteBuffer;
        }
        byteBuffer.position((int) (position - zzo));
    }
