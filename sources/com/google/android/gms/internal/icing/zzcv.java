...
final class zzcv implements zzgr {
    ...
    private zzcv(zzct zzct) {
        this.zzge = (zzct) zzdl.zza((Object) zzct, "output");
    }
    ...
    public final void zza(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzt(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zzb(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzw(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zzc(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zze(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zzd(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzf(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zze(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzh(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zzf(int i, List<Float> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzb(((Float) list.get(i)).floatValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zzg(int i, List<Double> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzb(((Double) list.get(i)).doubleValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zzh(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzy(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zzi(int i, List<Boolean> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzh(((Boolean) list.get(i)).booleanValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zzj(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzu(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zzk(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzx(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zzl(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzi(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zzm(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzv(((Integer) list.get(i)).intValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
    ...
    public final void zzn(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = i;
            while (i < list.size()) {
                i3 += zzct.zzg(((Long) list.get(i)).longValue());
                i++;
            }
            this.zzge.zzp(i3);
            while (i2 < list.size()) {
