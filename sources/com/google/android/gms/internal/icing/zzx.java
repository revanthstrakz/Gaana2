...
import com.google.android.gms.internal.icing.zzak.zza.zza;
...
public final class zzx extends AbstractSafeParcelable {
    ...
    public static zzh zza(Intent intent, String str, Uri uri, String str2, List<AppIndexingLink> list) {
        ...
        if (uri != null) {
            zzh.zza(new zzl(uri.toString(), new zzt("web_url").zzb(true).zzd("url").zzc()));
        }
        if (list != null) {
            zza zzf = zzak.zza.zzf();
            zzb[] zzbArr = new zzb[list.size()];
            for (int i = 0; i < zzbArr.length; i++) {
                zzb.zza zzh2 = zzb.zzh();
            ...
            zzh.zza(new zzl(((zzak.zza) ((zzdj) zzf.zzca())).toByteArray(), new zzt("outlinks").zzb(true).zzd(".private:outLinks").zzc("blob").zzc()));
        }
        str = intent.getAction();
        if (str != null) {
            zzh.zza(zza("intent_action", str));
        }
        str = intent.getDataString();
        if (str != null) {
            zzh.zza(zza("intent_data", str));
        }
