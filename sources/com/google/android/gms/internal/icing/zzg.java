...
public final class zzg extends AbstractSafeParcelable {
    ...
    @Constructor
    zzg(@Param(id = 1) zzl[] zzlArr, @Param(id = 2) String str, @Param(id = 3) boolean z, @Param(id = 4) Account account) {
        this.zzi = zzlArr;
        this.zzj = str;
        this.zzk = z;
    ...
    zzg(String str, boolean z, Account account, zzl... zzlArr) {
        this(zzlArr, str, z, account);
        if (zzlArr != null) {
