...
final class zzgf {
    ...
    private static int zzd(byte[] bArr, int i, int i2) {
        int i3 = bArr[i - 1];
        switch (i2 - i) {
            case 0:
                return zzal(i3);
            case 1:
                return zzo(i3, bArr[i]);
            case 2:
                return zzc(i3, bArr[i], bArr[i + 1]);
            default:
    ...
    L_0x004c:
        r8 = new com.google.android.gms.internal.icing.zzgi;
        r8.<init>(r2, r4);
        throw r8;
    L_0x0052:
        r2 = r2 + 1;
    ...
    L_0x007b:
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.icing.zzgf.zza(java.lang.CharSequence):int");
    }
    ...
    static {
        zzgg zzgh;
        Object obj = (zzgd.zzdr() && zzgd.zzds()) ? 1 : null;
        if (obj == null || zzcb.zzal()) {
            zzgh = new zzgh();
        } else {
            zzgh = new zzgj();
        }
