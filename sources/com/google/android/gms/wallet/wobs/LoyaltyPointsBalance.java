...
public final class LoyaltyPointsBalance extends AbstractSafeParcelable {
    ...
    public final class Builder {
        ...
        public final Builder setInt(int i) {
            LoyaltyPointsBalance.this.zzgv = i;
            LoyaltyPointsBalance.this.zzgz = 0;
            return this;
        }

        public final Builder setString(String str) {
            LoyaltyPointsBalance.this.zzgw = str;
            LoyaltyPointsBalance.this.zzgz = 1;
            return this;
        }

        public final Builder setDouble(double d) {
            LoyaltyPointsBalance.this.zzgx = d;
            LoyaltyPointsBalance.this.zzgz = 2;
            return this;
        }

        public final Builder setMoney(String str, long j) {
            LoyaltyPointsBalance.this.zzbo = str;
            LoyaltyPointsBalance.this.zzgy = j;
            LoyaltyPointsBalance.this.zzgz = 3;
            return this;
        }
