...
public final class MaskedWallet extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public final class Builder {
        ...
        /* synthetic */ Builder(MaskedWallet maskedWallet, zzw zzw) {
            this();
        }
    }
    ...
    public static Builder newBuilderFrom(MaskedWallet maskedWallet) {
        ...
        Builder email = new Builder(new MaskedWallet(), null).setGoogleTransactionId(maskedWallet.getGoogleTransactionId()).setMerchantTransactionId(maskedWallet.getMerchantTransactionId()).setPaymentDescriptions(maskedWallet.getPaymentDescriptions()).setInstrumentInfos(maskedWallet.getInstrumentInfos()).setEmail(maskedWallet.getEmail());
        MaskedWallet.this.zzdb = maskedWallet.zzdb;
        MaskedWallet.this.zzdc = maskedWallet.zzdc;
