...
public class AccountChangeEvent extends AbstractSafeParcelable {
    ...
    public String toString() {
        ...
        int i = this.zzi;
        StringBuilder stringBuilder = new StringBuilder(((91 + String.valueOf(str).length()) + String.valueOf(obj).length()) + String.valueOf(str2).length());
