...
public class lw {
    ...
    public lw a(Object obj, Object obj2) {
        return a(obj, obj2, null);
    }

    public lw a(Object obj, Object obj2, Comparator<?> comparator) {
    ...
    public lw a(double d, double d2) {
        if (this.a != 0) {
            return this;
        }
    ...
    public lw a(Object[] objArr, Object[] objArr2, Comparator<?> comparator) {
