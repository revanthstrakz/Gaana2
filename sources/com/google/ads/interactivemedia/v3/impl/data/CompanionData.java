...
public abstract class CompanionData {
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder(((((66 + String.valueOf(companionId).length()) + String.valueOf(size).length()) + String.valueOf(src).length()) + String.valueOf(clickThroughUrl).length()) + String.valueOf(valueOf).length());
