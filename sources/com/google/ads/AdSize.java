...
public final class AdSize {
    ...
    public static final AdSize IAB_MRECT = new AdSize(HttpStatusCodes.STATUS_CODE_MULTIPLE_CHOICES, Callback.DEFAULT_SWIPE_ANIMATION_DURATION, "as");
    public static final AdSize IAB_WIDE_SKYSCRAPER = new AdSize(MoEHelperUtils.BASELINE_SCREEN_DPI, 600, "as");
