...
public final class StoredChannel implements Serializable {
    ...
    public String toString() {
        return Objects.toStringHelper(StoredChannel.class).add("notificationCallback", getNotificationCallback()).add(AudienceNetworkActivity.CLIENT_TOKEN, getClientToken()).add("expiration", getExpiration()).add("id", getId()).add("topicId", getTopicId()).toString();
    }
