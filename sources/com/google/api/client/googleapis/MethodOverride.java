...
public final class MethodOverride implements HttpExecuteInterceptor, HttpRequestInitializer {
    ...
    private boolean overrideThisMethod(HttpRequest httpRequest) throws IOException {
        ...
        if (requestMethod.equals(HttpMethods.GET) ? httpRequest.getUrl().build().length() <= 2048 : !this.overrideAllMethods) {
            return httpRequest.getTransport().supportsMethod(requestMethod) ^ 1;
        }
        return true;
    }
}
