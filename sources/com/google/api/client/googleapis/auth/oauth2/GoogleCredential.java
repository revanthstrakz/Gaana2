...
public class GoogleCredential extends Credential {
    ...
    public TokenResponse executeRefreshToken() throws IOException {
        ...
        payload.setExpirationTimeSeconds(Long.valueOf(currentTimeMillis + 3600));
    ...
    private static GoogleCredential fromStreamServiceAccount(GenericJson genericJson, HttpTransport httpTransport, JsonFactory jsonFactory) throws IOException {
        ...
        Builder serviceAccountPrivateKeyId = new Builder().setTransport(httpTransport).setJsonFactory(jsonFactory).setServiceAccountId(str).setServiceAccountScopes(Collections.emptyList()).setServiceAccountPrivateKey(privateKeyFromPkcs8(str2)).setServiceAccountPrivateKeyId(str3);
        String str4 = (String) genericJson.get("token_uri");
        if (str4 != null) {
            serviceAccountPrivateKeyId.setTokenServerEncodedUrl(str4);
        }
        String str5 = (String) genericJson.get("project_id");
        if (str5 != null) {
            serviceAccountPrivateKeyId.setServiceAccountProjectId(str5);
        }
