...
class DefaultCredentialProvider extends SystemEnvironmentProvider {
    ...
    private com.google.api.client.googleapis.auth.oauth2.GoogleCredential getCredentialUsingEnvironmentVariable(com.google.api.client.http.HttpTransport r7, com.google.api.client.json.JsonFactory r8) throws java.io.IOException {
        /*
        r6 = this;
        r0 = "GOOGLE_APPLICATION_CREDENTIALS";
        r0 = r6.getEnv(r0);
        r1 = 0;
        r2 = new java.io.FileInputStream;	 Catch:{ IOException -> 0x001e }
        r2.<init>(r0);	 Catch:{ IOException -> 0x001e }
        r7 = com.google.api.client.googleapis.auth.oauth2.GoogleCredential.fromStream(r2, r7, r8);	 Catch:{ IOException -> 0x0019, all -> 0x0016 }
    ...
    L_0x001e:
        r7 = move-exception;
    L_0x001f:
        r8 = new java.io.IOException;	 Catch:{ all -> 0x001c }
        r2 = "Error reading credential file from environment variable %s, value '%s': %s";
        r3 = 3;
        r3 = new java.lang.Object[r3];	 Catch:{ all -> 0x001c }
        r4 = 0;
        r5 = "GOOGLE_APPLICATION_CREDENTIALS";
        r3[r4] = r5;	 Catch:{ all -> 0x001c }
        r4 = 1;
        r3[r4] = r0;	 Catch:{ all -> 0x001c }
        r0 = 2;
        r4 = r7.getMessage();	 Catch:{ all -> 0x001c }
        r3[r0] = r4;	 Catch:{ all -> 0x001c }
        r0 = java.lang.String.format(r2, r3);	 Catch:{ all -> 0x001c }
        r8.<init>(r0);	 Catch:{ all -> 0x001c }
        r7 = com.google.api.client.googleapis.auth.oauth2.OAuth2Utils.exceptionWithCause(r8, r7);	 Catch:{ all -> 0x001c }
        r7 = (java.io.IOException) r7;	 Catch:{ all -> 0x001c }
    ...
    private com.google.api.client.googleapis.auth.oauth2.GoogleCredential getCredentialUsingWellKnownFile(com.google.api.client.http.HttpTransport r6, com.google.api.client.json.JsonFactory r7) throws java.io.IOException {
        /*
        r5 = this;
        r0 = r5.getWellKnownCredentialsFile();
        r1 = 0;
        r2 = new java.io.FileInputStream;	 Catch:{ IOException -> 0x001c }
        r2.<init>(r0);	 Catch:{ IOException -> 0x001c }
        r6 = com.google.api.client.googleapis.auth.oauth2.GoogleCredential.fromStream(r2, r6, r7);	 Catch:{ IOException -> 0x0017, all -> 0x0014 }
    ...
    L_0x001c:
        r6 = move-exception;
    L_0x001d:
        r7 = new java.io.IOException;	 Catch:{ all -> 0x001a }
        r2 = "Error reading credential file from location %s: %s";
        r3 = 2;
        r3 = new java.lang.Object[r3];	 Catch:{ all -> 0x001a }
        r4 = 0;
        r3[r4] = r0;	 Catch:{ all -> 0x001a }
        r0 = 1;
        r6 = r6.getMessage();	 Catch:{ all -> 0x001a }
        r3[r0] = r6;	 Catch:{ all -> 0x001a }
        r6 = java.lang.String.format(r2, r3);	 Catch:{ all -> 0x001a }
