...
public final class JacksonFactory extends JsonFactory {
    ...
    public JacksonFactory() {
        this.factory.a(Feature.AUTO_CLOSE_JSON_CONTENT, false);
    }
    ...
    public JsonGenerator createJsonGenerator(OutputStream outputStream, Charset charset) throws IOException {
        return new JacksonGenerator(this, this.factory.a(outputStream, JsonEncoding.UTF8));
    }

    public JsonGenerator createJsonGenerator(Writer writer) throws IOException {
        return new JacksonGenerator(this, this.factory.a(writer));
    }
    ...
    public JsonParser createJsonParser(String str) throws IOException {
        ...
        return new JacksonParser(this, this.factory.a(str));
    }
