...
final class LZ4JavaUnsafeCompressor extends LZ4Compressor {
    ...
    /* JADX WARNING: Missing block: B:15:0x0066, code skipped:
            net.jpountz.util.UnsafeUtils.writeByte(r3, r10, (int) com.google.android.exoplayer2.extractor.ts.PsExtractor.VIDEO_STREAM_MASK);
    ...
    /* JADX WARNING: Missing block: B:24:0x009d, code skipped:
            net.jpountz.util.UnsafeUtils.writeByte(r3, r10, net.jpountz.util.UnsafeUtils.readByte(r3, r10) | 15);
            r10 = net.jpountz.lz4.LZ4UnsafeUtils.writeLen(r9 - 15, r3, r12);
     */
    /* JADX WARNING: Missing block: B:25:0x00ad, code skipped:
            net.jpountz.util.UnsafeUtils.writeByte(r3, r10, r9 | net.jpountz.util.UnsafeUtils.readByte(r3, r10));
            r10 = r12;
     */
    ...
    /* JADX WARNING: Missing block: B:29:0x00df, code skipped:
            if (net.jpountz.lz4.LZ4UnsafeUtils.readIntEquals(r0, r8, r15) != false) goto L_0x00ea;
     */
    ...
    L_0x002a:
        ...
        goto L_0x00f9;
    L_0x002d:
        r14 = net.jpountz.util.UnsafeUtils.readInt(r0, r8);
        r14 = net.jpountz.lz4.LZ4Utils.hash64k(r14);
        r15 = net.jpountz.util.UnsafeUtils.readShort(r2, r14);
        r15 = r15 + r1;
        r16 = r11;
        r11 = r8 - r1;
        net.jpountz.util.UnsafeUtils.writeShort(r2, r14, r11);
        r11 = net.jpountz.lz4.LZ4UnsafeUtils.readIntEquals(r0, r15, r8);
    ...
    L_0x0066:
        ...
        r13 = r11 + -15;
        r12 = net.jpountz.lz4.LZ4UnsafeUtils.writeLen(r13, r3, r12);
        goto L_0x0077;
    L_0x0072:
        r13 = r11 << 4;
        net.jpountz.util.UnsafeUtils.writeByte(r3, r10, r13);
    ...
    L_0x007b:
        ...
        r8 = r8 + 4;
        r15 = r15 + 4;
        r9 = net.jpountz.lz4.LZ4UnsafeUtils.commonBytes(r0, r15, r8, r6);
        r11 = r12 + 6;
        r13 = r9 >>> 8;
        r11 = r11 + r13;
    ...
    L_0x009d:
        r11 = net.jpountz.util.UnsafeUtils.readByte(r3, r10);
        r11 = r11 | r14;
        net.jpountz.util.UnsafeUtils.writeByte(r3, r10, r11);
        r9 = r9 + -15;
        r9 = net.jpountz.lz4.LZ4UnsafeUtils.writeLen(r9, r3, r12);
        r10 = r9;
        goto L_0x00b6;
    L_0x00ad:
        r11 = net.jpountz.util.UnsafeUtils.readByte(r3, r10);
    ...
    L_0x00ba:
        r9 = r8 + -2;
        r11 = net.jpountz.util.UnsafeUtils.readInt(r0, r9);
        r11 = net.jpountz.lz4.LZ4Utils.hash64k(r11);
        r9 = r9 - r1;
        net.jpountz.util.UnsafeUtils.writeShort(r2, r11, r9);
        r9 = net.jpountz.util.UnsafeUtils.readInt(r0, r8);
        r9 = net.jpountz.lz4.LZ4Utils.hash64k(r9);
        r11 = net.jpountz.util.UnsafeUtils.readShort(r2, r9);
        r15 = r1 + r11;
        r11 = r8 - r1;
        net.jpountz.util.UnsafeUtils.writeShort(r2, r9, r11);
        r9 = net.jpountz.lz4.LZ4UnsafeUtils.readIntEquals(r0, r8, r15);
    ...
    L_0x00f9:
        r2 = r4 - r1;
        r4 = r10;
        r0 = net.jpountz.lz4.LZ4UnsafeUtils.lastLiterals(r0, r1, r2, r3, r4, r5);
        r0 = r0 - r22;
        return r0;
        */
    ...
    /* JADX WARNING: Missing block: B:30:0x00c2, code skipped:
            net.jpountz.util.UnsafeUtils.writeByte(r3, r10, r1 | net.jpountz.util.UnsafeUtils.readByte(r3, r10));
            r10 = r14;
     */
    ...
    /* JADX WARNING: Missing block: B:38:0x00fe, code skipped:
            if (net.jpountz.lz4.LZ4UnsafeUtils.readIntEquals(r0, r11, r7) != false) goto L_0x0101;
     */
    ...
    public int compress(byte[] r20, int r21, int r22, byte[] r23, int r24, int r25) {
        ...
        r2 = r22;
        r3 = r23;
        net.jpountz.util.UnsafeUtils.checkRange(r20, r21, r22);
        net.jpountz.util.UnsafeUtils.checkRange(r23, r24, r25);
        r5 = r24 + r25;
    ...
    L_0x003b:
        ...
        goto L_0x00d0;
    L_0x003e:
        r14 = net.jpountz.util.UnsafeUtils.readInt(r0, r7);
        r14 = net.jpountz.lz4.LZ4Utils.hash(r14);
        r15 = r11;
        r11 = net.jpountz.util.UnsafeUtils.readInt(r8, r14);
        r16 = r12;
        r12 = r7 - r11;
    ...
    L_0x0056:
        r17 = net.jpountz.lz4.LZ4UnsafeUtils.readIntEquals(r0, r11, r7);
    ...
    L_0x007c:
        ...
        r1 = r13 + -15;
        r14 = net.jpountz.lz4.LZ4UnsafeUtils.writeLen(r1, r3, r14);
        goto L_0x008d;
    L_0x0088:
        r1 = r13 << 4;
        net.jpountz.util.UnsafeUtils.writeByte(r3, r10, r1);
    ...
    L_0x0091:
        ...
        r7 = r7 + 4;
        r11 = r11 + 4;
        r1 = net.jpountz.lz4.LZ4UnsafeUtils.commonBytes(r0, r11, r7, r4);
        r9 = r14 + 6;
        r11 = r1 >>> 8;
        r9 = r9 + r11;
    ...
    L_0x00b2:
        ...
        net.jpountz.util.UnsafeUtils.writeByte(r3, r10, r11);
        r1 = r1 + -15;
        r1 = net.jpountz.lz4.LZ4UnsafeUtils.writeLen(r1, r3, r14);
        r10 = r1;
        goto L_0x00cb;
    L_0x00c2:
        r11 = net.jpountz.util.UnsafeUtils.readByte(r3, r10);
    ...
    L_0x00d8:
        r1 = r7 + -2;
        r11 = net.jpountz.util.UnsafeUtils.readInt(r0, r1);
        r11 = net.jpountz.lz4.LZ4Utils.hash(r11);
        net.jpountz.util.UnsafeUtils.writeInt(r8, r11, r1);
        r1 = net.jpountz.util.UnsafeUtils.readInt(r0, r7);
    ...
    L_0x00fa:
        r13 = net.jpountz.lz4.LZ4UnsafeUtils.readIntEquals(r0, r11, r7);
    ...
    L_0x0073:
        ...
        r16 = r12;
        r12 = net.jpountz.util.UnsafeUtils.readInt(r7, r15);
        r17 = r13;
        r13 = r6 - r12;
