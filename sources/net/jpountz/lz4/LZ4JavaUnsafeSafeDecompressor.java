...
final class LZ4JavaUnsafeSafeDecompressor extends LZ4SafeDecompressor {
    ...
    public int decompress(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) {
        ...
        if (i4 != 0) {
            ...
            int i11 = i6;
            while (true) {
                int readByte = UnsafeUtils.readByte(bArr3, i10) & 255;
                i10++;
                i7 = readByte >>> 4;
                if (i7 == 15) {
                    i8 = -1;
                    while (i10 < i5) {
                        i8 = i10 + 1;
                        byte readByte2 = UnsafeUtils.readByte(bArr3, i10);
                        int i12;
                        if (readByte2 != (byte) -1) {
                            i12 = i8;
                            i8 = readByte2;
                ...
                LZ4UnsafeUtils.wildArraycopy(bArr3, i10, bArr4, i11, i7);
                i10 = UnsafeUtils.readShortLE(bArr3, i14);
                i14 += 2;
                i10 = i82 - i10;
                if (i10 < i6) {
                ...
                if (i11 == 15) {
                    ...
                    while (i14 < i5) {
                        readByte = i14 + 1;
                        byte readByte3 = UnsafeUtils.readByte(bArr3, i14);
                        if (readByte3 != (byte) -1) {
                            i14 = readByte;
                            readByte = readByte3;
                            break;
                ...
                readByte = i82 + i11;
                if (readByte <= i13) {
                    LZ4UnsafeUtils.wildIncrementalCopy(bArr4, i10, i82, readByte);
                } else if (readByte > i9) {
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("Malformed input at ");
                    stringBuilder.append(i14);
                    ...
                    LZ4UnsafeUtils.safeIncrementalCopy(bArr4, i10, i82, i11);
                }
                i11 = readByte;
                i10 = i14;
            }
            if (i82 > i9) {
                ...
                LZ4UnsafeUtils.safeArraycopy(bArr3, i10, bArr4, i11, i7);
                return i82 - i6;
            }
        } else if (i5 == 1 && UnsafeUtils.readByte(bArr, i) == (byte) 0) {
            return 0;
        } else {
