    ...
    public int decompress(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        ...
        if (i3 != 0) {
            ...
            while (true) {
                int i6;
                byte readByte;
                int readByte2 = SafeUtils.readByte(bArr, i4) & 255;
                i4++;
                int i7 = readByte2 >>> 4;
                if (i7 == 15) {
                    while (true) {
                        i6 = i4 + 1;
                        readByte = SafeUtils.readByte(bArr, i4);
                        if (readByte != (byte) -1) {
                            break;
                        }
                        i7 += 255;
                ...
                if (i6 <= i8) {
                    LZ4SafeUtils.wildArraycopy(bArr, i4, bArr2, i5, i7);
                    i4 += i7;
                    i5 = SafeUtils.readShortLE(bArr, i4);
                    i4 += 2;
                    i5 = i6 - i5;
                    if (i5 < i2) {
                    ...
                    i7 = i6 + readByte2;
                    if (i7 <= i8) {
                        LZ4SafeUtils.wildIncrementalCopy(bArr2, i5, i6, i7);
                    } else if (i7 > i3) {
                        stringBuilder = new StringBuilder();
                        stringBuilder.append("Malformed input at ");
                        stringBuilder.append(i4);
                        ...
                        LZ4SafeUtils.safeIncrementalCopy(bArr2, i5, i6, readByte2);
                    }
                    i5 = i7;
                } else if (i6 != i3) {
                    stringBuilder = new StringBuilder();
                    ...
                    LZ4SafeUtils.safeArraycopy(bArr, i4, bArr2, i5, i7);
                    return (i4 + i7) - i;
                }
            }
        } else if (SafeUtils.readByte(bArr, i) == (byte) 0) {
            return 1;
        } else {
