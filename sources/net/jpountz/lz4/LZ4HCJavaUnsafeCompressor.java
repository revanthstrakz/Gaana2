...
final class LZ4HCJavaUnsafeCompressor extends LZ4Compressor {
    ...
    private class HashTable {
        ...
        static {
            Class cls = LZ4HCJavaUnsafeCompressor.class;
        }
        ...
        public boolean insertAndFindBestMatch(byte[] bArr, int i, int i2, Match match) {
            ...
            int i5 = hashPointer;
            for (hashPointer = 0; hashPointer < LZ4HCJavaUnsafeCompressor.this.maxAttempts && i5 >= Math.max(this.base, (i - 65536) + 1) && i5 <= i; hashPointer++) {
    ...
    public int compress(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) {
        ...
        while (i10 < i8) {
            ...
            if (hashTable.insertAndFindBestMatch(bArr3, i10, i9, match2)) {
                    ...
                    if (match2.start - match5.start < 3) {
                        ...
                        while (true) {
                            ...
                            if (match2.start >= match5.end() + 3) {
                                ...
                                i11 = i5;
                                match12 = match;
                                i14 = LZ4UnsafeUtils.encodeSequence(bArr, i11, match5.start, match5.ref, match5.len, bArr2, i14, i7);
                                i10 = match5.end();
                        ...
                        byte[] bArr5 = bArr2;
                        i15 = i7;
                        i5 = LZ4UnsafeUtils.encodeSequence(bArr4, match5.end(), match7.start, match7.ref, match7.len, bArr5, LZ4UnsafeUtils.encodeSequence(bArr4, i5, match5.start, match5.ref, match5.len, bArr5, i14, i15), i15);
                        i11 = match7.end();
                        i10 = i11;
                        match = match8;
                        match3 = match7;
                ...
                match7 = match3;
                match8 = match;
                i5 = LZ4UnsafeUtils.encodeSequence(bArr, i5, match5.start, match5.ref, match5.len, bArr2, i14, i7);
                i11 = match5.end();
                i10 = i11;
                match = match8;
                match3 = match7;
        ...
        return LZ4UnsafeUtils.lastLiterals(bArr, i11, i6 - i11, bArr2, i5, i7) - i3;
    }
