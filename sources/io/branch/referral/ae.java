...
class ae extends ServerRequest {
    e g;
    ...
    public void a(int i, String str) {
        if (this.g != null) {
            e eVar = this.g;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Trouble validating the referral code. ");
            stringBuilder.append(str);
    ...
    public boolean a(Context context) {
        ...
        if (this.g != null) {
            this.g.onInitFinished(null, new e("Trouble validating the referral code.", -102));
        }
        return true;
    }
